...
2. **METHOD**:
  ...
  - Run the script: `rosrun exp2_postlab turtlesim_hex.py`
3. **CODE**:
  - turtlesim_hex.py
```python
#!/usr/bin/env python3
...
```
4. **RESULT**: Successfully launched a turtlebot and moved it in the hexagon shape
